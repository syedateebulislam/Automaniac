 ...
 *2- if possible,add js notification to say "Hang on!! we are launching your browser..."
 *3- Think also from mobile device perspective.
 *4- where to put chromeDriver.exe to launch when deployed(maybe war)
 *
 * */
